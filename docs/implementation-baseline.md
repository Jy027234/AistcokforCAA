...
8. **S2 正式财务事实链**——BaoStock 缺 F07/F09 所需绝对值，Tushare 因付费权限退出。巨潮对 8 家普通工商企业 64/64 期已完成公告关联；601012、600519、000333 的五期官方 PDF 各有 16/16 个 S2 必需候选值，累计 **48/48 候选、0/48 正式 PIT 事实**。601012 的一对年报修订关系有更正公告证明；600519 和 000333 两只正分母样本的 F07–F09 可由原文诊断重算。定期报告与全分类索引的官方组织 ID、请求体、分页和公告关联现可归档复核；逐值、逐更正候选审阅的持久准入层已实现。601012 的全分类真实样本已检出定期报告分类漏掉的更正公告；实际人工复核、其它期间更正链、合格证券池覆盖、决策日 F10 和金融行业独立模板尚未通过。CNINFO 本地研究及保存已按公开披露登记，不能扩大解释为商用或再分发许可。上交所结构化概览缺合并净利润与归母权益，且 600519“营业总收入”不能冒充 F09 营业收入，见 ADR-015。S2 继续关闭；领域层和 API 阻止新建 `family=S2`，该项不阻断 S1 首期试运行。
